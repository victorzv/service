...
open class ApiClient(val baseUrl: String) {
    ...
    protected inline fun <reified T : Any?> request(requestConfig: RequestConfig, body: Any? = null): ApiInfrastructureResponse<T?> {
        var httpUrl = baseUrl.toHttpUrlOrNull() ?: throw IllegalStateException("baseUrl is invalid.")
//
//        httpUrl = httpUrl.resolve(requestConfig.path)
        val tempHttpUrl = httpUrl ?: throw IllegalStateException("baseUrl is invalid.")
        httpUrl = tempHttpUrl.resolve(requestConfig.path)!!
